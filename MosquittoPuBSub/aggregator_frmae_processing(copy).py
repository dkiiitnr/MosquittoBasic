...
def update_log_file(mode, error):
    ...
    Output_frame = pd.DataFrame(data,
                                columns=['Mode', 'Emergency_switch', 'Stop switch', 'Destintion_Position', 'Bag Status',
                                         'Parcel Status', 'Error'])
...
def main():
    ...
    mode = input("Enter Server Assigned Mode: ")
    emergency_switch = input("Enter Emergency_switch Status: ")
    stop_manual_switch = input("Enter Stop Manual Switch Status: ")
    destintion_position = input("Enter Destination Position: ")
    bag_status = input("Enter bag Status: ")
    parcel_status = input("Enter Parcel Status: ")

    print(mode + str(" ") + emergency_switch + str(" ") + stop_manual_switch + str(" ") + (
        destintion_position) + str(" ") + bag_status + str(" ") + parcel_status)
    if mode:
